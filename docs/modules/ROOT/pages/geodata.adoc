...
* Country codes use https://www.iso.org/obp/ui/#search[official ISO 3166-1-alpha-2 code of a country]
* Continent codes see https://datahub.io/core/continent-codes[datahub.io]
