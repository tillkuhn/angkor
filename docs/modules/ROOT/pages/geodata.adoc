...
* For UI Visualization in Angular try https://material.angular.io/components/tree/examples[ mat-tree provides a Material Design styled tree that can be used to display hierarchy data.]
