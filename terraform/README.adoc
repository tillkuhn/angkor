...
https://code.visualstudio.com/docs/remote/linux[VS Code: Remote - SSH] used to be a perfect way to edit remote files, but the glibc and libstdc++ versions required by newer versions are not available on Amazon Linux 2.
