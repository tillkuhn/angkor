...
type Config struct {
	...
	SmtpDryrun     bool   `default:"false" desc:"Dry run, dump mail to STDOUT instead of send" split_words:"true"`
	...
	KafkaGroupID   string `default:"app.remindabot" desc:"Group ID for Kafka Consumer" split_words:"true"`
}
