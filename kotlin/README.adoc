...
** The CloudEvents Kafka protocol binding provides two content modes for transferring data, see https://eda-visuals.boyney.io/visuals/cloudevents[Understanding CloudEvents] for a nice visualization:
...
** https://learn.microsoft.com/en-us/azure/event-grid/cloud-event-schema[MS CloudEvents v1.0 schema with Azure Event Grid]
** https://github.com/cloudevents/spec/blob/main/cloudevents/spec.md[SPEC CloudEvents - Version 1.0.3-wip]
** https://dev.to/eminetto/using-cloudevents-in-go-58kh[Using CloudEvents in Go]
...
{
	"specversion": "1.0",
	"id": "4b3aa393-f353-4540-8c77-************",
	"source": "dev.timafe.net/angkor-api/application/startup",
	"type": "net.timafe.angkor.domain.Event",
	"datacontenttype": "application/json",
	"subject": "Service angkor-api Spring Boot/4.x.x Kotlin/2.x.x Java 25.x.x is ready for business on port 1234",
	"time": "2026-01-13T15:29:34.17227Z",
	"data": {
		"action": "startup",
		"message": "Service angkor-api Spring Boot/4.x.x Kotlin/2.x.x Java 25.x.x is ready for business on port 1234",
		"source": "Application",
		"time": "2026-01-13T15:29:34.1564Z",
		"userId": "00000000-0000-0000-0000-000000000001"
	}
}
----

.Example Event Header (content type is important for CloudEventDeserializer)
----
{
	"content-type": "application/cloudevents+json",
	"client_id": "4b3aa393-f353-4540-8c77-********"
}
----
